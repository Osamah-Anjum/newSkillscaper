...
const sectors = [
  {
    ...
    icon: (<svg viewBox="0 0 40 40" fill="none" className="w-7 h-7"><rect x="17" y="6" width="6" height="28" rx="3" fill="currentColor" opacity="1"/><rect x="6" y="17" width="28" height="6" rx="3" fill="currentColor" opacity="1"/></svg>),
  },
  {
    ...
    icon: (<svg viewBox="0 0 40 40" fill="none" className="w-7 h-7"><polyline points="4,30 14,18 22,24 36,10" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" opacity="1"/><circle cx="36" cy="10" r="3" fill="currentColor" opacity="1"/></svg>),
  },
  {
    ...
    icon: (<svg viewBox="0 0 40 40" fill="none" className="w-7 h-7"><line x1="8" y1="26" x2="32" y2="26" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="1"/><path d="M10 26 Q20 10 30 26" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="1"/><circle cx="20" cy="12" r="2" stroke="currentColor" strokeWidth="2" opacity="1"/></svg>),
  },
  {
    ...
    icon: (<svg viewBox="0 0 40 40" fill="none" className="w-7 h-7"><path d="M20 6 L32 10 V18 C32 26 26 32 20 34 C14 32 8 26 8 18 V10 L20 6 Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" opacity="1"/></svg>),
  },
  {
    ...
    icon: (<svg viewBox="0 0 40 40" fill="none" className="w-7 h-7"><path d="M20 6 L36 14 L20 22 L4 14 Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="1"/><path d="M10 18 L10 28 Q10 34 20 34 Q30 34 30 28 L30 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="1"/></svg>),
  },
  {
    ...
    icon: (<svg viewBox="0 0 40 40" fill="none" className="w-7 h-7"><rect x="6" y="16" width="28" height="18" rx="3" stroke="currentColor" strokeWidth="2" opacity="1"/><path d="M13 16 Q13 8 20 8 Q27 8 27 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="1"/></svg>),
  },
]
...
function SectorCard({ sector }: { sector: typeof sectors[0] }) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className="group rounded-2xl p-6 border border-accent/10 hover:border-accent/35 bg-[#000001] transition-colors duration-300 cursor-pointer"
    >
      <div className="flex items-start justify-between mb-4">
        <div className="text-accent">{sector.icon}</div>
        <span className="text-xs font-mono text-accent/30">{sector.id}</span>
      </div>
...
export default function Sectors() {
  return (
    <section id="sectors" className="py-24 md:py-32 section-divider bg-[#000001]">
      <div className="px-6 sm:px-12 lg:px-20 xl:px-28">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <h2 className="font-display uppercase font-bold text-4xl md:text-5xl text-pearl leading-tight max-w-lg">
